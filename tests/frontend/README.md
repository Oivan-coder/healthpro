...
- `smoke.cjs`: real frontend auth client and app controller with simulated API responses;
  login, errors, password change gate, logout, roles, navigation, drawer and modal focus.
- `responsive.cjs`: CSS parsing and cascade checks at 320–1440 px, including form display,
