...
const ROUTER_PROMPT = [
  ...
  "Свободная разговорная речь, опечатки и сокращения допустимы: «скока мне лет», «че с ОАК», «ддимер», «как делишки».",
  ...
  "«Сколько мне лет», имя, пол, день рождения — profile; «как дела/как ты» — casual; ОАК/ОАМ/биохимия — lab_group.",
  ...
  "Для обычного разговора, профиля, документов и анамнеза не выбирай лабораторные коды.",
